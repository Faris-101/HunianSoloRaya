...
export default function Projects() {
  ...
  return (
    <section
      id="proyek"
      className="px-5 py-14 md:px-8 md:py-20 lg:px-16 lg:py-24"
    >
        ...
        {PROJECTS.map((p, i) => (
          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 px-4 py-4 project-overlay text-white md:px-6 md:py-6">
              <div className="text-[0.6rem] tracking-[0.12em] uppercase text-gold mb-1 md:text-[0.65rem]"></div>
              <div className="font-serif text-[1rem] font-normal mb-0.5 leading-tight md:text-[1.2rem]">
                {p.name}
              </div>
              <div className="text-[0.7rem] text-white/55 hidden sm:block">
                {p.location}
              </div>
              <div className="text-[0.75rem] text-gold/80 font-serif mt-1">
                {p.price}
              </div>
            </div>
